...
for(pref in prefix_list){
  ...
  dflist[[counter]]$norm_eigen_decomp <- unlist(read.table(file = paste(folder, "/eigen_decomp_of_cov.dat", sep ="")))
...
write.table(dat, paste("mean_across_fish/", genotype,"_", age,"_", Rearing_conditions, "_mean_datatable_registered.dat", sep =""))
...
write.table(df, paste("mean_across_fish/", genotype,"_", age,"_", Rearing_conditions, "_all_assemblies_datatable_registered.dat", sep =""))
